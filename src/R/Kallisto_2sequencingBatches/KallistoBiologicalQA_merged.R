...
write.csv(csamples,file="~/Git/UPSCb/projects/spruce-somatic-embryogenesis/doc/technical_samples.csv")
...
write.csv(counts,file="analysis/kallisto/raw-unormalised-gene-expression_data.csv")
...
#' Save it
save(dds.counts,file="~/Git/UPSCb/projects/spruce-somatic-embryogenesis/DESeqDataSet.rda")
...
#' Write it out
write.csv(vst.counts,file="~/Git/UPSCb/projects/spruce-somatic-embryogenesis/library-size-corrected_blind-variance-stabilised_gene-expression_data.csv")
